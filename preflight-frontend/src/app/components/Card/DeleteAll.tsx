...
const DeleteProduct = ({ onAllDeleted }: DeleteAllProps) => {
    ...
    const handleDeleteAll = async () => {
        setIsLoading(true);
        try {
            // Optimistically clear list in SWR cache
            await swrMutate('/stock', () => [], false);

            // Backend: DELETE /stock/all (no body)
            await del<{ msg: string }>('/stock/all');
    ...
    return (
        <>
            <div
                className="group border-2 border-red-500 py-2.5 max-w-[150px] h-full button hover:bg-red-500 transition"
            ...
            >
                ...
                <span className="text-red-600 group-hover:text-white font-medium">
                    Delete All
                </span>
            </div>
                ...
                <div className="flex flex-col gap-4 p-6 w-full bg-white rounded-xl shadow-md">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg border">
                        <p className="text-gray-600 text-center mb-2">
                            Are you sure you want to delete <strong>all</strong> products?
                        </p>
                        <p className="text-sm text-gray-500 text-center mt-1">
                            This will remove every product from the list.
                        </p>
                    </div>
